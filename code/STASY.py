...
for train_index,test_index in kf.split(total_sequence,li_enc_stance):
    ...
    text_final_temp = lstm_temp

    input2_temp = Input (shape = (512,1))
    lstm2_temp = Bidirectional(LSTM(100, name='lstm_inp2_temp', activation='tanh',dropout=.2,kernel_regularizer=regularizers.l2(0.07)))(input2_temp)
    text_use_temp = lstm2_temp

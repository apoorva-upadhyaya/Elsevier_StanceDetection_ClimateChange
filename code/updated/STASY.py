...
for train_index,test_index in kf.split(total_sequence,li_enc_stance):
    ...
    model=Model([input1_stance,input2_stance,input1_senti,input2_senti,input1_temp,input2_temp],[act_specific_output,senti_specific_output,temp_specific_output])
    ##Compile
    ...
    model.fit([train_sequence,train_embeddings,train_sequence,train_embeddings,train_sequence,train_embeddings],[train_stance,train_senti,train_temp], shuffle=True,validation_split=0.2,epochs=20,verbose=2)
